...
ourRequest.open('GET','js9.json' )
    ...
    for(ui = 1; ui < timeSpoken.length; ui++) {
        time_acc[ui] = time_acc[ui-1] + time_acc[ui];
    };      //
    ...
    // Center text on rectangle
        ...
        var multi_lines=format_text(svgContainer,test_data[i].speech,25,parseInt(x_r) + 35,parseInt(y_r) + 50);
...
function format_text(object,sentences,width,x,y){
